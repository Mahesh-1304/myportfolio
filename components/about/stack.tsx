...
const CHIPS: Chip[] = [
  ...
  { label: "NumPy",        slug: "numpy",       bg: "#013243", fg: "#ffffff" },
  { label: "Scikit-learn", slug: "scikitlearn", bg: "#F7931E", fg: "#ffffff" },
  { label: "TensorFlow",   slug: "tensorflow",  bg: "#FF6F00", fg: "#ffffff" },
  { label: "PyTorch",      slug: "pytorch",     bg: "#EE4C2C", fg: "#ffffff" },
  { label: "OpenCV",       slug: "opencv",      bg: "#5C3EE8", fg: "#ffffff" },
  { label: "Power BI",     slug: "powerbi",     bg: "#F2C811", fg: "#000000" },
  { label: "Jupyter",      slug: "jupyter",     bg: "#F37626", fg: "#ffffff" },
